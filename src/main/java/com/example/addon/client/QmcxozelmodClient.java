...
public class QmcxozelmodClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        HudRenderCallback.EVENT.register((drawContext, renderTickCounter) -> {
            ...
            if (resistance != null) {
                ...
                drawContext.drawTexture(VIGNETTE_TEXTURE, 0, 0, 0, 0.0F, 0.0F, width, height, width, height);
